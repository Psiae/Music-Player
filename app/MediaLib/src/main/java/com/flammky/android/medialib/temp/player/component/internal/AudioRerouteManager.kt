package com.flammky.android.medialib.temp.player.component.internal
...
import com.flammky.android.medialib.temp.player.component.AudioRerouteInfo
...
internal open class AudioRerouteManager(
	...
	private val audioManager = context.android.systemService.audioManager
