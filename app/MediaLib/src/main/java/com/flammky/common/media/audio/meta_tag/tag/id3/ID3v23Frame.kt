...
import com.kylentt.musicplayer.common.media.audio.meta_tag.FileConstants
...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.EmptyFrameException
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.InvalidDataTypeException
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.InvalidFrameException
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.InvalidFrameIdentifierException
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Compression.uncompress
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.convertFrameID22To23
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.convertFrameID23To24
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.convertFrameID24To23
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.copyObject
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.forceFrameID22To23
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.forceFrameID24To23
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.isID3v22FrameIdentifier
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.isID3v23FrameIdentifier
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.isID3v24FrameIdentifier
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3TextEncodingConversion.getTextEncoding
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.framebody.AbstractID3v2FrameBody
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.framebody.FrameBodyDeprecated
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.framebody.FrameBodyUnsupported
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.framebody.ID3v23FrameBody
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.valuepair.TextEncoding
import com.kylentt.musicplayer.common.media.audio.meta_tag.utils.EqualsUtil.areEqual
