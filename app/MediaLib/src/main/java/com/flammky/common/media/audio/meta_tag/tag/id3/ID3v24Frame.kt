...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.Lyrics3Line
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Compression.uncompress
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3SyncSafeInteger.bufferToValue
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3SyncSafeInteger.isBufferEmpty
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3SyncSafeInteger.isBufferNotSyncSafe
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3SyncSafeInteger.valueToBuffer
...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.forceFrameID23To24
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Tags.isID3v23FrameIdentifier
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Unsynchronization.requiresUnsynchronization
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Unsynchronization.synchronize
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.ID3Unsynchronization.unsynchronize
...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.lyrics3.*
