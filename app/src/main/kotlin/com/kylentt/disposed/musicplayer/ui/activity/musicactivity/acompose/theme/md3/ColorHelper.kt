...
object ColorHelper {
    ...
    @Composable
    fun getDNTextColor() =
        if (isSystemInDarkTheme()) ColorDefaults.lightText else ColorDefaults.darkText

    @Composable
    fun getDNBackground() =
        if (isSystemInDarkTheme()) ColorDefaults.darkThemeBackground else ColorDefaults.lightThemeBackground
