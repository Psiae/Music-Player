package com.kylentt.mediaplayer.disposed.domain.mediaSession.service
...
import com.kylentt.mediaplayer.disposed.core.exoplayer.ControllerCommand
import com.kylentt.mediaplayer.disposed.core.exoplayer.ExoController
import com.kylentt.mediaplayer.disposed.core.exoplayer.NotifProvider
import com.kylentt.mediaplayer.disposed.core.exoplayer.util.ExoUtil
...
import com.kylentt.mediaplayer.disposed.domain.mediaSession.service.MusicServiceConstants.MEDIA_SESSION_ID
import com.kylentt.mediaplayer.disposed.domain.mediaSession.service.MusicServiceConstants.NEW_SESSION_PLAYER
import com.kylentt.mediaplayer.disposed.domain.mediaSession.service.MusicServiceConstants.NEW_SESSION_PLAYER_RECOVER
...
internal class MusicService : MediaLibraryService() {
  ...
  override fun onDestroy() {
    ...
    if (!MainActivity.isAlive) {
      Timber.d("MusicService ExitProcess, current Activity State: ${MainActivity.activityStateStr}")
      exitProcess(0)
    }
  }
