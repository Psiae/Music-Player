package com.kylentt.mediaplayer.ui.mainactivity.disposed.compose.theme
...
object ThemeHelper {
    ...
    fun Context.getDynamicM3Color(darkTheme: Boolean): ColorScheme {
        ...
        return if (hasDynamic) {
            ...
            if (darkTheme) { Md3Defaults.defaultDarkThemeColors() } else { Md3Defaults.defaultLightThemeColors() }
        }
    }
