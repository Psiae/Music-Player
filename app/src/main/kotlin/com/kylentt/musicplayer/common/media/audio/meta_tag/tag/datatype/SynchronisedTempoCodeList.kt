...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.framebody.FrameBodySYTC

/**
 * List of [SynchronisedTempoCode]s.
 *
...
class SynchronisedTempoCodeList : AbstractDataTypeList<SynchronisedTempoCode> {
	...
	override fun createListElement(): SynchronisedTempoCode {
		return SynchronisedTempoCode(DataTypes.OBJ_SYNCHRONISED_TEMPO, body)
	}
}
