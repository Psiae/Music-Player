...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.NumberFixedLength
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.StringNullTerminated
...
class FrameBodyAENC : AbstractID3v2FrameBody, ID3v24FrameBody, ID3v23FrameBody {
	...
	override val identifier: String
		get() = ID3v24Frames.FRAME_ID_AUDIO_ENCRYPTION
	...
	constructor() {
		...
		setObjectValue(DataTypes.OBJ_PREVIEW_START, 0.toShort())
		setObjectValue(DataTypes.OBJ_PREVIEW_LENGTH, 0.toShort())
	 ...
	 * @param data
	 */
	constructor(owner: String?, previewStart: Short, previewLength: Short, data: ByteArray?) {
	...
	override fun setupObjectList() {
		...
		objectList.add(NumberFixedLength(DataTypes.OBJ_PREVIEW_LENGTH, this, 2))
