...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.StringFixedLength
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.StringNullTerminated
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.StringSizeTerminated
 ...
 * @version $Id$
 */
class FrameBodyLINK : AbstractID3v2FrameBody, ID3v24FrameBody, ID3v23FrameBody {


	override val identifier: String?
		get() = ID3v24Frames.FRAME_ID_LINKED_INFO
	 ...
	 */
	constructor(frameIdentifier: String?, url: String?, additionalData: String?) {
