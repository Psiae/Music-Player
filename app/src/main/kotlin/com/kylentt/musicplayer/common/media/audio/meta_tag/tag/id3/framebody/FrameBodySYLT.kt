...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.datatype.*
...
import com.kylentt.musicplayer.common.media.audio.meta_tag.tag.id3.valuepair.SynchronisedLyricsContentType
 ...
 *
 * <center></center><table border=0 width="70%">
...
class FrameBodySYLT : AbstractID3v2FrameBody, ID3v24FrameBody, ID3v23FrameBody {
	...
	override val identifier: String
		get() = ID3v24Frames.FRAME_ID_SYNC_LYRIC
