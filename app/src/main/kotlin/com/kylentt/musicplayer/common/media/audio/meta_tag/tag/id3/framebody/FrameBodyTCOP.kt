 ...
 * @version $Id$
 */
class FrameBodyTCOP : AbstractFrameBodyTextInfo, ID3v24FrameBody, ID3v23FrameBody {

	override val identifier: String
		get() = ID3v24Frames.FRAME_ID_COPYRIGHTINFO

	/**
	 * Creates a new FrameBodyTCOP datatype.
	 */
	constructor()
	constructor(body: FrameBodyTCOP) : super(body)
