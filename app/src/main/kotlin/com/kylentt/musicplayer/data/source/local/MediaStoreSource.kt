...
data class MediaStoreSong(
    ...
    override fun getAlbumName(): String { return album }
         ...
         try {
            ...
            cursor?.use {
                ...
                while (cursor.moveToNext()) {
                    ...
                    val albumUri = ContentUris.withAppendedId(Uri.parse(ProviderConstants.MEDIASTORE_ALBUM_ART_PATH), albumId)
                    val songUri = ContentUris.withAppendedId(MediaStore.Audio.Media.EXTERNAL_CONTENT_URI, songId.toLong()).toString()

                    if (duration != 0L) {
                        songList.add(MediaStoreSong(
                            album = album,
