...
internal abstract class AudioColumns private constructor() : MediaColumns() {
	...
	protected val GENRE = MediaStore.Audio.AudioColumns.GENRE
	 ...
	 */
	protected val TITLE_RESOURCE_URI = MediaStore.Audio.AudioColumns.TITLE_RESOURCE_URI
	 ...
	 */
	@RequiresApi(Build.VERSION_CODES.R)
	protected open val ALBUM_ARTIST = MediaStore.Audio.AudioColumns.ALBUM_ARTIST
	 ...
	 */
	@RequiresApi(Build.VERSION_CODES.R)
	protected val COMPILATION = MediaStore.Audio.AudioColumns.COMPILATION
