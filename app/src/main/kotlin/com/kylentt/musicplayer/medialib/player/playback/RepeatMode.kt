package com.kylentt.musicplayer.medialib.player.playback
	...
	companion object {
		inline val @Player.RepeatMode Int.asRepeatMode: RepeatMode
			get() = when(this) {
				...
				Player.REPEAT_MODE_ONE -> RepeatMode.CURRENT
				Player.REPEAT_MODE_ALL -> RepeatMode.TIMELINE
		...
		inline val RepeatMode.toRepeatModeInt: Int
			get() = when(this) {
				...
				RepeatMode.CURRENT -> Player.REPEAT_MODE_ONE
				RepeatMode.TIMELINE -> Player.REPEAT_MODE_ALL
			}
	}
}
