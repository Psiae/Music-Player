package com.kylentt.musicplayer.ui.activity.musicactivity.compose.musicroot
...
fun shouldShowBottomNav(
  ...
  return MusicRootNavigation.routeList.map { it.routeName }.find { it == entry?.destination?.route }
    ?.let { true } ?: false
}
