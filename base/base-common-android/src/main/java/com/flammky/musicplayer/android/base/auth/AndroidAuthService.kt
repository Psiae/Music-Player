...
internal class AndroidAuthService(
	...
	override fun logout() {
		val (user: com.flammky.musicplayer.base.auth.r.user.AuthUser, mod: Int) = _stateLock.write {
			_loginJob.cancel()
	...
	companion object {
		private val INSTANCE = LazyConstructor<AndroidAuthService>()
		internal infix fun provides(app: Application) = INSTANCE.constructOrThrow(
			lazyValue = { AndroidAuthService(app) },
