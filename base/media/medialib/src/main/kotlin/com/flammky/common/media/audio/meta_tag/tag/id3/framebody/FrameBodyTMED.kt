 ...
 * <tr valign=top><td align=right>/A<br></br>&nbsp;</td><td>Analog transfer from media</td></tr>
 * <tr><td>ANA</td><td>Other analog media</td></tr>
 * <tr><td align=right>/WAC</td><td>Wax cylinder</td></tr>
 * <tr valign=top><td align=right>/8CA<br></br>&nbsp;</td><td>8-track tape cassette</td></tr>
 ...
 * <tr valign=top><td align=right>/AA<br></br>&nbsp;</td><td>AAD</td></tr>
 ...
 * <tr valign=top><td align=right>/80<br></br>&nbsp;</td><td>80 rpm</td></tr>
 ...
 * <tr valign=top><td align=right>/6<br></br>&nbsp;</td><td>mode 6, 44.1 kHz/16 bits, 'wide track' play</td></tr>
 ...
 * <tr valign=top><td align=right>&nbsp;/SECAM<br></br>&nbsp;</td><td>SECAM</td></tr>
 ...
 * <tr valign=top><td align=right>/BETA<br></br>&nbsp;</td><td>BETAMAX</td></tr>
 ...
 * <tr valign=top><td align=right>/MW<br></br>&nbsp;</td><td>MW</td></tr>
 * <tr><td>TEL</td><td>Telephone</td></tr>
 * <tr valign=top><td align=right>/I<br></br>&nbsp;</td><td>ISDN</td></tr>
 ...
 * <tr valign=top><td align=right>/IV<br></br>&nbsp;</td><td>Type IV cassette (metal)</td></tr>
 ...
 * <tr><td align=right>/II</td><td>Type II cassette (chrome)</td></tr>
 * <tr><td align=right>/III</td><td>Type III cassette (ferric chrome)</td></tr>
 * <tr><td align=right>/IV<br></br>&nbsp;</td><td>Type IV cassette (metal)</td></tr>
</table> *
 *
 *
 ...
 * @version $Id$
 */
class FrameBodyTMED : AbstractFrameBodyTextInfo, ID3v23FrameBody, ID3v24FrameBody {

	override val identifier: String?
		get() = ID3v24Frames.FRAME_ID_MEDIA_TYPE

	/**
	 * Creates a new FrameBodyTMED datatype.
	 */
	constructor()
	constructor(body: FrameBodyTMED) : super(body)
