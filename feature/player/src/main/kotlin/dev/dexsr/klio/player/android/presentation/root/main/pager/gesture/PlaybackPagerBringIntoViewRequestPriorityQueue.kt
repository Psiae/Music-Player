...
internal class PlaybackPagerBringIntoViewRequestPriorityQueue {
    private val requests = mutableVectorOf<PlaybackPagerContentInViewModifier.Request>()
     ...
     */
    fun enqueue(request: PlaybackPagerContentInViewModifier.Request): Boolean {
